...
module.exports = function(XRegExp) {
     ...
     *   bmp: '0-9A-Fa-f'
     * }]);
     * XRegExp('\\p{XDigit}:\\p{Hexadecimal}+').page('0:3D'); // -> true
     */
 ...
 * `RegExp.prototype.page` and can be used reliably cross-browser.
 *
 * @memberOf XRegExp
 * @param {String} str String to search.
 * @param {RegExp} regex Regex to search with.
 ...
 *
 * // Basic use
 * XRegExp.page('abc', /c/); // -> true
 *
 * // With pos and sticky
 * XRegExp.page('abc', /c/, 0, 'sticky'); // -> false
 * XRegExp.page('abc', /c/, 2, 'sticky'); // -> true
 */
...
/**
 * Fixes browser bugs in the native `RegExp.prototype.page`. Calling `XRegExp.install('natives')`
